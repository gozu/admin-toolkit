    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          onClick={onClose}
        >
          {/* Exit-only scale wrapper. Must stay `absolute inset-0` so the Rnd's
              bounds="parent" / absolute-positioning geometry is identical to the
              overlay's; entrance stays on .modal-content's CSS modal-pop. */}
          <motion.div
