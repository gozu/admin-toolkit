...
![Version](https://img.shields.io/badge/version-0.4.846-blue)
...
| Projects | Scenarios | Recent run outcomes and durations, sampled runtime load, configured schedules, live next/last runs, failure/silence/overlap/chain/run-as signals |
