...
const icons: Record<string, ReactNode> = {
  ...
  resources: (
    // Gauge — live usage monitor; the pulse glyph is taken by connections-health.
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="m12 14 4-4" />
  ...
  // Broken: warning triangle — envs whose last build attempt failed.
  'code-envs-broken': (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
  ...
  // A calendar with a small clock — scenarios are scheduled automation.
  scenarios: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div className={idx > 0 ? 'mt-4' : ''}>
      {!collapsed && (
        ...
        >
          <DisclosureChevron expanded={isOpen} className="-ml-0.5" />
          <span>{section.title}</span>
          {section.experimental && (
            <span
              title="Beta — under active development; behavior may change."
